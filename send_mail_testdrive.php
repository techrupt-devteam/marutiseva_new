...
//     'X-Mailer: PHP/' . phpversion();
 $headers = "From:" . $from;
    ...
    include('connection.php');
        ...
        $sql = "INSERT INTO `test_drive`(`model`, `test_drive_date`, `test_drive_time`, `name`, `email`, `phone_no`, `city`, `message`) VALUES ('$model','$td_date','$td_time','$full_name','$to','$phone_no','$city','$s_message')";
