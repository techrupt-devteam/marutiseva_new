...
if(isset($_POST['submit'])){
    ...
    $subject2 = "Enquiry for Driving School";
    ...
    $message2.='<body aria-readonly="false" style="cursor: auto;"><span style="font-size:14px"><span style="font-family:arial,helvetica,sans-serif"><strong>Hello Team,</strong></span></span><br />
		<br />';
	$message2.='<span style="font-size:12px"><strong><span style="font-family:arial,helvetica,sans-serif">Below are the details of the person requested for the driving school please call and proceed further.</span></strong></span><br />
		&nbsp;';
    ...
    include('connection.php');
        ...
        $sql = "INSERT INTO `driving_school_enquiries`(`name`, `email`, `mobile_no`) VALUES ('$full_name','$to','$phone_no')";
