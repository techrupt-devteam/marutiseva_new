...
if(isset($_POST['submit'])){
    ...
    $subject2 = "Enquiry for Finance";
    if($city == 'Nashik'){
        $admin="seva.nsk.fin1@marutidealers.com";
        // $admin="mayuri.hoh@gmail.com";
    }elseif($city == 'Nagpur'){
         $admin="seva.ngp.fin1@marutidealers.com";
    }elseif($city == 'Nanded'){
         $admin="seva.nnd.fin2@marutidealers.com";
    }else{
        $admin="seva.dhl.fin1@marutidealers.com";
    }
    ...
    $message2.='<body aria-readonly="false" style="cursor: auto;"><span style="font-size:14px"><span style="font-family:arial,helvetica,sans-serif"><strong>Hello Team,</strong></span></span><br />
		<br />';
	$message2.='<span style="font-size:12px"><strong><span style="font-family:arial,helvetica,sans-serif">Below are the details of the person requested for the Maruti Finance service please call and proceed further.</span></strong></span><br />
		&nbsp;';
    ...
    mail($admin,$subject2,$message2,$headers2); // admin
	 include('connection.php');
        ...
        $sql = "INSERT INTO `finance`(`name`, `email`, `phone_no`, `city`, `model`, `annual_income`, `purchase_time_frame`, `message`) VALUES ('$full_name','$to','$phone_no','$city','$model','$annual_income','$purchase_time','$s_message')";
